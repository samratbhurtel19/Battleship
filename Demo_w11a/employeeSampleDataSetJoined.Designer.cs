...
namespace Demo_w11a {
    ...
    public partial class employeeSampleDataSetJoined : global::System.Data.DataSet {
        ...
        public partial class NewTableDataTable : global::System.Data.TypedTableBase<NewTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NewTableRow AddNewTableRow() {
...
namespace Demo_w11a.employeeSampleDataSetJoinedTableAdapters {
...
SELECT countryID, countryName, regionID FROM countries WHERE (countryID = @countryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Demo_w11a.Properties.Settings.Default.employeeSampleConnectionString;
        }
...
FROM     employees INNER JOIN
                  ...
                  jobHistory ON departments.departmentID = jobHistory.departmentID INNER JOIN
                  locations ON departments.locationID = locations.locationID INNER JOIN
                  countries ON locations.countryID = countries.countryID CROSS JOIN
                  employee_pension CROSS JOIN
                  stats";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT employees.employeeID, employees.firstName, employees.email, employees.phoneNumber
FROM     employees INNER JOIN
                  departments ON employees.departmentID = departments.departmentID INNER JOIN
                  jobHistory ON departments.departmentID = jobHistory.departmentID INNER JOIN
                  locations ON departments.locationID = locations.locationID INNER JOIN
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(employeeSampleDataSetJoined.NewTableDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual employeeSampleDataSetJoined.NewTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            employeeSampleDataSetJoined.NewTableDataTable dataTable = new employeeSampleDataSetJoined.NewTableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        public virtual int FillBy(employeeSampleDataSetJoined.NewTableDataTable dataTable) {
        ...
        public virtual employeeSampleDataSetJoined.NewTableDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            employeeSampleDataSetJoined.NewTableDataTable dataTable = new employeeSampleDataSetJoined.NewTableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
